    ...
    RNNDrawer.create = function (Component) {
        var WrappedDrawer = /** @class */ (function (_super) {
            ...
            function WrappedDrawer(props) {
                ...
                if (_this.props.disablePanResponder) {
            ...
            WrappedDrawer.prototype.render = function () {
                ...
                return (React.createElement(react_native_1.View, __assign({ style: sideMenuContainerStyle }, this.props.disablePanResponder ? null : this.panResponder.panHandlers),
